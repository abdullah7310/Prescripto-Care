...
<div className='w-full h-auto flex items-center justify-center'>
  <div className='w-[90vw] h-[400px] sm:w-[85vw] sm:h-[80vh] bg-[#5F6FFF] mx-6 sm:mx-12 mt-10 rounded-[12px] flex gap-20 sm:flex-row p-6 sm:p-0 relative'>
    ...
    <div className='w-full sm:w-[55%] flex justify-center sm:justify-start items-end absolute bottom-0 sm:static mt-6 sm:mt-0'>
      ...
      <div className='mb-20 w-[90%] h-auto sm:w-[60%] sm:h-[50vh] flex flex-col items-center mt-20 sm:mb-8 m-auto lg:mb-40'>
        ...
        <div className=' w-[100%] h-auto flex mt-10  sm:w-full items-center justify-center flex-wrap gap-8'>
          {[
...
<div className='w-full flex sm:mb-8 items-center justify-center'>
  <div className='w-[90vw] h-auto sm:w-[85vw] sm:h-[50vh] bg-[#5F6FFF] sm:mx-12 mt-10 rounded-[12px] flex flex-col sm:flex-row p-6 sm:p-0'>
