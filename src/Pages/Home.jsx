    ...
    <>
      ...
      <div className='w-full sm:mt-[45px] mt-[40px] h-auto flex items-center justify-center'>
        <div className='w-[90vw] h-[400px] sm:w-[85vw] md:h-[350px] lg:w-[85vw] lg:h-[80vh] lg:mx-12  md:flex-row  sm:h-[80vh] bg-[#5F6FFF] mx-6 sm:mx-12 mt-10 rounded-[12px] flex gap-20 sm:flex-row p-6 sm:p-0 relative'>
          ...
          <div className='flex h-[50%] sm:h-[100%] flex-col justify-center sm:pl-[70px] w-full sm:w-[45%] text-center sm:text-left mt-4 sm:mt-0'>
            <h1 className='text-[25px] md:mb-2 md:text-[22px] lg:text-[43px]  lg:leading-[60px] md:leading-[30px] sm:text-[43px] font-outfit text-white font-medium leading-[40px] sm:leading-[60px]'>
              Book Appointment <br className='hidden sm:block' />
              With Trusted Doctors
            </h1>
          ...
          <div className='w-full  md:h-[100%] sm:w-[55%] flex justify-center sm:justify-start items-end absolute bottom-0 sm:static mt-6 sm:mt-0'>
            <img className='w-[80%] md:h-[80%] lg:h-[85%] sm:w-[100%] h-auto sm:h-[85%]' src={Doctors} alt="" />
          </div>
      ...
      <div className='mb-20 md:w-[80%]  w-[90%] h-auto sm:w-[60%] sm:h-[50vh] flex flex-col items-center mt-20 sm:mb-8 m-auto lg:mb-25'>
        <h1 className='text-[25px] sm:text-[30px] font-outfit font-normal text-center '>Find by Speciality </h1>
        <p className='text-center w-[70%] sm:w-[373px] text-xs font-outfit font-[300]'>Simply browse through our extensive list of trusted doctors, schedule your appointment hassle-free.</p>
        <div className=' w-[100%] h-auto grid grid-cols-2 sm:flex mt-10  sm:w-full sm:items-center sm:justify-center sm:flex-wrap gap-8'>
          {[
      ...
      <div className='w-[85vw] h-auto m-auto mt-6 grid grid-cols-1 sm:grid-cols-5 md:grid-cols-3 lg:grid-cols-5 gap-4 sm:gap-6 '>
        {filteredDoctors.slice(0, visibleDoctors).map((card, ind) => (
          <DoctorCard key={ind} image={card.image} doctorname={card.doctorname} title={card.title} />
        ))}
      </div>
      ...
      <div className='w-full  flex sm:mb-8 items-center justify-center'>
        <div className='w-[90vw] md:h-[350px] lg:h-[50vh] h-auto sm:w-[85vw] sm:h-[50vh] bg-[#5F6FFF] sm:mx-12 mt-10 rounded-[12px] flex flex-col sm:flex-row p-6 pb-0 sm:p-0'>
